                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Status <small>réservation des chambres </small>
                        </h1>
                    </div>
                </div>
				<?php
                    ...
                    <div class="panel panel-default">
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
											...
											<button class="btn btn-default" type="button">
												 Nouvelles chambres Réservées <span class="badge"><?php echo $c ; ?></span>
											</button>
											</a>
                                        </h4>
                                    </div>
                      ...
                      <!-- Fin de la table de base  --> 
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
											...
											<button class="btn btn-primary" type="button">
												 Chambres réservées confirmées <span class="badge"><?php echo $r ; ?></span>
											</button>
                                ...
                                <div class="panel panel-danger">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
											...
											<button class="btn btn-primary" type="button">
												 Abonnés  <span class="badge"><?php echo $f ; ?></span>
											</button>
											</a>
                                        </h4>
                                    </div>
                            ...
                            <div class="table-responsive">
								...
								<a href="messages.php" class="btn btn-primary">Plus d'action</a>
                            </div>
                        </div>
                    </div>
                                        </div>
