        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a  class="active-menu" href="room.php"><i class="fa fa-plus-circle"></i>Ajouter une chambre</a>
                    </li>
                    <li>
                        <a  href="roomdel.php"><i class="fa fa-desktop"></i> Supprimer une chambre</a>
                    </li>
                    ...
                    <div class="panel panel-primary">
						...
						<form name="form" method="post">
                            <div class="form-group">
							 ...
							 <input type="submit" name="add" value="Confirmer" class="btn btn-primary"> 
							</form>
							<?php
							 include('../db_gl.php');
							 if(isset($_POST['add']))
